...
namespace LocalHiringPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20260718034724_([MobileNumber] IS NOT NULL)")]
    partial class MobileNumberISNOTNULL
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LocalHiringPlatform.Domain.Entities.Experience.CandidateExperience", b =>
                {
                    b.Property<Guid>("EntityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LocalHiringPlatform.Domain.Entities.Experience.CandidateExperienceDetail", b =>
                {
                    b.Property<Guid>("EntityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CandidateExperienceId");

                    b.ToTable("CandidateExperienceDetails");
                });

            modelBuilder.Entity("LocalHiringPlatform.Domain.Entities.Experience.IndustryType", b =>
                {
                    b.Property<int>("IndustryTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LocalHiringPlatform.Domain.Entities.Experience.CandidateExperience", b =>
                {
                    ...
                    b.HasOne("LocalHiringPlatform.Domain.Entities.Experience.IndustryType", "IndustryType")
                        .WithMany("CandidateExperiences")
            ...
            modelBuilder.Entity("LocalHiringPlatform.Domain.Entities.Experience.CandidateExperienceDetail", b =>
                {
                    b.HasOne("LocalHiringPlatform.Domain.Entities.Experience.CandidateExperience", "CandidateExperience")
                        .WithMany("ExperienceDetails")
                        .HasForeignKey("CandidateExperienceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
